...
git push "https://$GH_TOKEN@github.com/morluna/SampleXcodeCloudTest.git" --set-upstream origin $BRANCH_NAME && gh pr create --title "🔖 Version Bump: $RELEASE_VERSION" --body "This PR was automatically created. Check out locally to resolve any conflicts."
